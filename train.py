...
class NeRFSystem(LightningModule):
    ...
    def configure_optimizers(self):
        ...
        if hparams.dataset_name!='phototourism':
            ...
            self.register_buffer('directions', self.train_dataset.all_rgbs.to(self.device))
            self.register_buffer('poses', torch.from_numpy(self.train_dataset.poses).to(self.device))
        if self.hparams.optimize_ext:
    ...
    def on_train_start(self):
        if hparams.dataset_name!='phototourism':
            ...
            self.model.mark_invisible_cells(self.train_dataset.Ks,
